        ...
        <div class="col-3 mb-3">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <input id="result-sea-cost" class="form-control" name="sea-cost" value="0 ₽" disabled>
                </div>
                <div class="col-4">
        ...
        <div class="col-3 mb-3">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <input id="result-rail-cost" class="form-control" name="rail-cost" value="0 ₽" disabled>
                </div>
                <div class="col-4">
        ...
        <div class="col-3 mb-3">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <input id="result-auto-cost" class="form-control" name="auto-cost" value="0 ₽" disabled>
                </div>
                <div class="col-4">
        ...
        <div class="col-3 mb-3">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <input id="result-rental-cost" class="form-control" name="rental-cost" value="0 ₽" disabled>
                </div>
            </div>
        </div>
    </div>
