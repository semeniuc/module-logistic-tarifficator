...
use Tarifficator\Controller\Api\ApiGetOptionController;
...
return [
    ...
    Route::post('/local/modules/logistic.tarifficator/' . 'api/option/get', [ApiGetOptionController::class, 'execute']),


    Route::get('/local/modules/logistic.tarifficator/' . 'api/option/get', [ApiGetOptionController::class, 'execute']),
];